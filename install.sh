...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202304291120-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Apr 29, 2023 11:21 EDT
# @@File             :  install.sh
# @@Description      :  Install configurations for fish
...
GLOBAL_OS_PACKAGES="fish direnv powerline hg "
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__run_pre_install() {
  ...
  [ -d "$PLUGIN_DIR/oh-my-fish" ] || [ -d "$PLUGIN_DIR/inst" ] || git_clone "https://github.com/oh-my-fish/oh-my-fish" "$PLUGIN_DIR/inst"
  return $getRunStatus
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
