...
function fish_prompt --description 'Custom powerline-style prompt matching bash'
    ...
    set -l color_bg_purple (set_color --background purple)
    set -l color_bg_red (set_color --background red)
    set -l color_bg_green (set_color --background green)
    set -l color_bg_yellow (set_color --background yellow)
    set -l color_bg_magenta (set_color --background magenta)
    set -l color_bg_blue (set_color --background blue)
    set -l color_fg_white (set_color white)
    set -l color_fg_black (set_color black)
    ...
    if git rev-parse --git-dir >/dev/null 2>&1
        ...
        set -l git_untracked (git ls-files --others --exclude-standard 2>/dev/null)
